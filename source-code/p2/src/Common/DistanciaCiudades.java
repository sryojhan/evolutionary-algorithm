...
public class DistanciaCiudades {
	...
	private final static int[] distanciaMadrid = {251, 422, 563, 115, 401, 621, 395, 237, 297, 663, 417, 190, 400, 609, 167, 721, 434, 58, 632, 397, 335, 333, 465, 336, 551, 544, 401};
	...
	public static int DistanciaMadrid(int ciudad) {
		
		return distanciaMadrid[ciudad];
	}
	
	
	public static String NombreCiudad(int idx) {
		return nombres[idx];
	}
